...
func main() {
	...
	fmt.Println("this is the prime: ", prime_factors2(8))
	fmt.Println("this is the prime: ", prime_factors3(8))
	fmt.Println("this is the fib: ", fib2(8))
	fmt.Println("this is the fib: ", fib3(8))

	A := []int{1, 2, 4, 5, 9, 2, 9, 1}
	fmt.Println("this is the array sort: ", array_sort2(A))
	fmt.Println("this is the array sort: ", array_sort3(A))

	fmt.Println("this is the array duplicate: ", remove_duplicate2(A))

	fmt.Println("this is the array duplicate: ", array_duplicate3(A))

	fmt.Println("this is the array max: ", highest_num2(A))

	fmt.Println("this is the array low: ", lowest_num2(A))

	fmt.Println("this is the reverse: ", reverse2(A))
	fmt.Println("this is the reverse another: ", reverse3(A))

	fmt.Println("this is the fizz buzz: ", fizzBuzz(10))
	fmt.Println("this is the fizz buzz: ", fizzBuzz2(10))
	fmt.Println("this is the fizz buzz: ", fizzBuzz3(10))

	fmt.Println("the vowel: ", vowel2("this is the man now"))

	fmt.Println("the runes : ", ReverseString2("this is the man now"))
...
func array_duplicate3(arr []int) []int {
...
func remove_duplicate2(arr []int) []int {
	keys := make(map[int]bool)
	newArray := []int{}
